...
Pod::Spec.new do |s|
  s.name             = 'MAGSocialGoogle'
  s.version          = '0.0.4'
  s.summary          = 'MAGSocialGoogle is a custom API for Google'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
MAGSocialGoogle provides custom API for Google features.
Supported features: TODO
  ...
  s.source_files = 'MAGSocialGoogle/Classes/**/*'
